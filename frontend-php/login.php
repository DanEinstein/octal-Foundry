    ...
    <div class="px-4 py-2">
        <div class="w-100 rounded-xl shadow-lg position-relative d-flex flex-column justify-content-end overflow-hidden"
            ...
            <div class="position-relative z-2 p-4">
                <h1 class="text-white fw-bold display-6 mb-0">Enter the Forge</h1>
                <p class="text-secondary small mt-1 mb-0">Start building with Octal Foundry</p>
            </div>
        </div>
    </div>

    <!-- Login Form Section -->
    <div class="d-flex flex-column px-4 py-4 gap-3">
        <!-- Email Field -->
        <div class="d-flex flex-column gap-1">
            ...
            <div class="position-relative">
                ...
                <input type="email" class="form-control form-control-dark rounded-3 ps-5 py-3" placeholder="student@university.edu">
            </div>
        </div>
        ...
        <div class="d-flex flex-column gap-1">
            <div class="d-flex justify-content-between align-items-center px-1">
                <p class="text-secondary small fw-bold text-uppercase mb-1" style="font-size: 0.75rem; letter-spacing: 0.05em;">Security Key</p>
                <button class="btn btn-link text-primary-orange text-decoration-none p-0 small fw-bold" style="font-size: 0.75rem;">Forgot?</button>
            </div>
            <div class="position-relative">
                ...
                <input type="password" class="form-control form-control-dark rounded-3 ps-5 py-3" placeholder="••••••••">
                <span class="material-symbols-outlined position-absolute top-50 translate-middle-y text-secondary end-0 me-3" style="cursor: pointer;">visibility</span>
            </div>
        </div>
        ...
        <a href="index.php" class="btn bg-primary-orange text-white fw-bold py-3 rounded-3 d-flex align-items-center justify-content-center gap-2 glow-orange border-0 shadow-lg w-100">
        ...
        <!-- Social Login -->
        <button class="btn btn-outline-secondary text-white fw-medium py-3 rounded-3 d-flex align-items-center justify-content-center gap-3 w-100 border-opacity-25 bg-transparent hover-bg-dark">
        ...
        <div class="pt-3 pb-4 text-center">
            <p class="text-secondary small">
                New to the Foundry?
                <a href="#" class="text-primary-orange fw-bold text-decoration-none">Join the cohort</a>
            </p>
        </div>
    </div>
